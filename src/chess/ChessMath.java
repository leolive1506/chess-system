...
public class ChessMath {
  ...
  public ChessPiece performChessMove(ChessPosition sourcPosition, ChessPosition targetPosition) {
    ...
    if (testCheck(currentPlayer)) {
      ...
      throw new ChessException("You can't yourselft in check");
    }
  ...
  private Piece makeMove(Position source, Position target) {
    ...
    p.increaseMoveCount();
    // se houver peça no lugar de destino, é a peça capturada
